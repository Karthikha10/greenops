    ...
    <div className="analytics-page">
      ...
      {loading && !payload ? <div className="analytics-loading">Loading the selected telemetry window…</div> : (
        <>
          ...
          <div className="analytics-method-note"><div className="method-icon">i</div><div><strong>How to explain this screen to the jury</strong><p>The KPI strip is the selected window’s summary. The line and area charts show direction by day. The ledger proves when data was present, while the day drill-down shows which servers, cooling readings, storage snapshots, and power readings produced that day’s result. Energy is timestamp-integrated; water and carbon remain explicitly marked estimates.</p></div></div>
        </>
      )}
    </div>
  );
